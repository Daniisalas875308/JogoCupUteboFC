        ...
        <div className="jogo-card stats-card">
            <div className="stat-item">
              <div className="stat-info">
                ...
                <p className="stat-value text-orange">20</p>
                <p className="stat-detail">5 grupos de 4</p>
              </div>
            </div>
        </div>
        ...
        <div className="jogo-card stats-card">
            <div className="stat-item">
              <div className="stat-info">
                ...
                <p className="stat-value text-blue">31</p>
                <p className="stat-detail">Grupos + 7 eliminatorias</p>
              </div>
            </div>
        </div>
        ...
        <div className="jogo-card">
          ...
          <div className="card-content">
            <div className="prize-item prize-blue">
              ...
              <div className="time-bold">17:00 - 21:00</div>
            </div>
            ...
            <div className="prize-item prize-blue">
              ...
              <div className="time-bold">10:00 - 21:00</div>
            </div>
        ...
        <div className="jogo-card">
          ...
          <div className="card-content">
            <div className="prize-item prize-gold">
              ...
              <div className="time-bold-bby">Experiencia en Karts </div>
            </div>
